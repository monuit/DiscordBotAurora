        ...
        if (action === 'start') {
            ...
            if (process.env.ENABLE_X_TWITTER !== 'true') {
                const disabledEmbed = new EmbedBuilder()
                    .setDescription("❌ X (Twitter) auto-posting is currently disabled.")
                    .setColor("#ff0000");
            ...
            if (client.autoWebScrapeSender) {
                try {
                    ...
                    const embed = new EmbedBuilder()
                        .setTitle("🔴 X (Twitter) Auto-Posting Stopped")
            ...
            if (client.autoWebScrapeSender) {
                try {
                    ...
                    const embed = new EmbedBuilder()
                        .setTitle("📊 X (Twitter) Auto-Posting Status")
                        ...
                        .addFields(
                            ...
                            { name: "🔧 Environment", value: process.env.ENABLE_X_TWITTER === 'true' ? "Enabled" : "Disabled", inline: true }
                        )
