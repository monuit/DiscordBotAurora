...
module.exports = {
    name: ["auto", "video", "set"],
    description: "Set auto videos posting in your channel",
    options: [
        {
            name: 'channel',
        ...
        interaction.deferReply().then(async () => {
            ...
            if (!joinSys) {
                ...
                const successEmbed = new EmbedBuilder()
                    .setDescription(`successfully created auto video posting in your guild you will get random content every ~15 mins in your channel`)
                    .setColor(client.color);
                ...
                const successEmbed = new EmbedBuilder()
                    .setDescription(`you have updated your channel or webhook to get random videos`)
                    .setColor(client.color);
