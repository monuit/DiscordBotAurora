...
const { isPremiumGuild } = require('../../utils/premiumBypass');
...
module.exports = {
    ...
    run: async (interaction, client) => {
        interaction.deferReply().then(async () => {
            ...
            // Premium check bypassed for self-hosted bot - isPremiumGuild always returns true
            console.log('[Set Left-Right] Premium check bypassed for self-hosted bot');
