...
class MainClient extends Client {
  constructor() {
    ...
    // Initialize presence rotation system
    const PresenceRotation = require('./utils/presenceRotation');
    this.presenceRotation = new PresenceRotation(this);

    // Initialize auto-promotional system
